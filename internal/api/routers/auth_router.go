...
func AuthRouter(server *gin.Engine) {
	...
	server.POST("/authentication/create_username", middlewares.AuthUsername, handlers.CreateUsername)
	server.PUT("/authentication/change_username", middlewares.AuthUsername, handlers.ChangeUsername)
